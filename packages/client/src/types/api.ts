...
export interface definitions {
  ...
  getExecuteBuyV3Response: {
    steps?: definitions["Model88"];
    path?: definitions["Model90"];
  };
  ...
  Model98: {
    ...
    source?: string;
    feeBps?: number;
    feeBreakdown?: definitions["Model97"];
    status?: string;
    expiration: number;
    createdAt: string;
    updatedAt: string;
  ...
  Model129: {
    ...
    lastSell?: definitions["lastBuy"];
    owner?: string;
    attributes?: definitions["Model128"];
  };
  Model130: {
    id?: string;
    price?: number;
  ...
  Model131: {
    floorAsk?: definitions["Model130"];
    topBid?: definitions["topBid"];
  };
  Model132: {
    token?: definitions["Model129"];
    market?: definitions["Model131"];
  };
  ...
  getTransfersBulkV1Response: {
    transfers?: definitions["Model142"];
    continuation?: string;
  };
  Model143: {
    type?: string;
  ...
  ownersDistribution: definitions["Model149"][];
  ...
  getCollectionActivityV3Response: {
    continuation?: string;
    activities?: definitions["Model155"];
  };
  Model156: {
    type?: string;
    fromAddress?: string;
  ...
  getCollectionActivityV2Response: {
    continuation?: string;
    activities?: definitions["Model157"];
  };
  Model158: {
    id?: string;
  };
  ...
  Model161: {
    collection?: definitions["Model158"];
    floorAsk?: definitions["Model159"];
    event?: definitions["Model160"];
  };
  ...
  Model170: {
    token?: definitions["Model120"];
    floorAsk?: definitions["Model169"];
    event?: definitions["Model160"];
  };
  Model171: definitions["Model170"][];
  getTokensFloorAskV3Response: {
    events?: definitions["Model171"];
    continuation?: string;
  };
  message: {
    id: string;
  ...
  Model184: {
    collection?: definitions["Model182"];
    ownership?: definitions["Model183"];
  };
  ...
  getUserActivityV1Response: {
    continuation?: number;
    activities?: definitions["Model187"];
  };
  metadata: {
    imageUrl?: string;
    discordUrl?: string;
  ...
  getUserCollectionsV1Response: {
    collections?: definitions["Model190"];
  };
  set: {
    id?: string;
    metadata?: definitions["Model103"];
  ...
  positions: definitions["Model191"][];
  ...
  Model195: {
    ...
    ownership?: definitions["Model194"];
  };
  ...
  lastSells: definitions["Model205"][];
  Model206: {
    key: string;
    value: string;
    tokenCount: number;
  ...
  Model214: {
    ...
    /** @enum {string} */
    kind: "string" | "number" | "date" | "range";
    values?: definitions["Model213"];
  };
  Model215: definitions["Model214"][];
  getAttributesStaticV1Response: {
    attributes?: definitions["Model215"];
  };
  Model216: {
    key: string;
    value: string;
  ...
  getAttributesExploreV3Response: {
    attributes?: definitions["Model217"];
  };
  Model218: {
    contract?: string;
    tokenId?: string;
  ...
  Model241: {
    syncDetails?: definitions["Model240"];
    fromBlock: number;
    toBlock: number;
  ...
  Model245: string[];
  Model246: {
    collections: definitions["Model245"];
  };
  ...
  seaport_offers: definitions["Model254"][];
  Model255: {
  ...
  rawOrders: definitions["Model265"][];
  ...
  Model269: {
    ...
    source?: string;
    feesOnTop?: definitions["Model268"];
    /**
     * @description If true, partial orders will be accepted.
     * @default false
     */
  ...
  Model272: {
    orderIds?: definitions["orderIds"];
    rawOrders?: definitions["Model271"];
    tokens?: definitions["Model266"];
    /** @description Quantity of tokens user is buying. Only compatible when buying a single ERC1155 token. Example: `5` */
    quantity?: number;
    /** @description Address of wallet filling the order. Example: `0xF296178d553C8Ec21A2fBD2c5dDa8CA9ac905A00` */
