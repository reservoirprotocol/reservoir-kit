...
describe(`It should test the executeSteps Method.`, (): void => {
  test('Shold execute signTypedDataSpy method.', (): Promise<void> => {
        ...
        path: [
          {
            orderId:
              '0x9db77ab93c65535e87b4a3922671fca06721bd84e96450fa6e8decf3b42c8759',
            contract: '0xba6666b118f8303f990f3519df07e160227cce87',
            tokenId: '8',
            quantity: 1,
            source: 'opensea.io',
            currency: '0x0000000000000000000000000000000000000000',
            ...
            builtInFees: [
              {
                ...
                amount: 0.00006,
                rawAmount: '62500000000000',
              },
              {
                bps: 1000,
                kind: 'royalty',
                recipient: '0xb17e8166e683b592e32f46e27d2e093e8d4622a7',
                amount: 0.00025,
                rawAmount: '250000000000000',
              },
            ],
            feesOnTop: [],
            totalPrice: 0.0025,
